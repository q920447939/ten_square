...
import cn.withmes.common.utils.FastJsonUtil;
...
public class RedisCacheAspect {
     ...
     */
    @Pointcut("@annotation(xin.cymall.common.redis.RedisCache)")
     ...
     */
    @Pointcut("@annotation(xin.cymall.common.redis.RedisEvict)")
